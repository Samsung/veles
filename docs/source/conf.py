...
# pixels large.
html_favicon = "_static/veles.ico"
...
htmlhelp_basename = 'VelesMachineLearningPlatformdoc'
...
latex_documents = [
  ('index', 'VelesMachineLearningPlatform.tex',
   'Veles Machine Learning Platform Documentation',
   'Samsung R\\&D Institute Russia', 'manual'),
]
...
man_pages = [
    ('index', 'velesmachinelearningplatform',
     'Veles Machine Learning Platform Documentation',
...
texinfo_documents = [
  ('index', 'VelesMachineLearningPlatform', 'Veles Machine Learning Platform Documentation',
   'Samsung R&D Institute Russia', 'VelesMachineLearningPlatform', 'One line description of project.',
   'Miscellaneous'),
]
