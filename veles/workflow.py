...
class Workflow(Container):
    ...
    def change_unit(
            self, prev_unit_name, new_unit, save_gates=True, save_attrs=True,
            units_to_link_to=[], units_to_link_from=[]):
        """
        ...
        :param save_attrs: determines whether transmission of attributes
        ...
        attributes_to = prev_unit.attributes_to
        attributes_from = prev_unit.attributes_from
        ...
        # Data links
        if save_attrs:
            for attribute in attributes_to:
                unit_from, attr_unit_from, attr_unit_to = attribute
                new_unit.link_attrs(
                    unit_from, (attr_unit_to, attr_unit_from))

            for attribute in attributes_from:
                unit_to, attr_unit_from, attr_unit_to = attribute
                unit_to.link_attrs(
                    new_unit, (attr_unit_to, attr_unit_from))
